...
`Eilison\LaAdmin\Widgets\Box` used to generate box components:

```php
use Eilison\LaAdmin\Widgets\Box;
...
`Eilison\LaAdmin\Widgets\Collapse` class used to generate folding components:
```php
use Eilison\LaAdmin\Widgets\Collapse;
...
`Eilison\LaAdmin\Widgets\Form` class is used to quickly build a form:
...
`Eilison\LaAdmin\Widgets\InfoBox` class is used to generate the information presentation block:

```php
use Eilison\LaAdmin\Widgets\InfoBox;
...
`Eilison\LaAdmin\Widgets\Tab` class is used to generate the tab components:

```php
use Eilison\LaAdmin\Widgets\Tab;
...
`Eilison\LaAdmin\Widgets\Table` class is used to generate tables:

```php
use Eilison\LaAdmin\Widgets\Table;
